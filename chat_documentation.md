...
*   **توضیحات:** ارسال یک پیام جدید و ایجاد مکالمه در صورت نیاز.
    *   اگر مکالمه‌ای بین فرستنده و گیرنده وجود نداشته باشد، به صورت خودکار ایجاد می‌شود.
*   **بدنه درخواست (Request Body):**
    ...
    ```
    *   `recipient_id`: شناسه‌ی کاربری که پیام را دریافت می‌کند.
