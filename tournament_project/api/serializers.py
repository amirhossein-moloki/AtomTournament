...
class TournamentSerializer(serializers.ModelSerializer):
    class Meta:
        model = Tournament
        fields = ('id', 'name', 'game', 'start_date', 'end_date', 'is_free', 'entry_fee', 'rules', 'format', 'participants', 'teams')

class MatchSerializer(serializers.ModelSerializer):
    class Meta:
        model = Match
        fields = ('id', 'tournament', 'round', 'team1', 'team2', 'winner', 'result_proof', 'is_confirmed', 'is_disputed')
